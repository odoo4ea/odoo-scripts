...
```
wget https://raw.githubusercontent.com/odoo4ea/odoo/16.0/install_odoo_ubuntu.sh
```
...
```OE_VERSION``` is the Odoo version to install, for example ```16.0``` for Odoo V14.<br/>
